...
<br/><br/><br/><br/>
# 后续计划
&emsp;&emsp;这个项目目前还只是做了很短期的尝试，开放出的模型是比较糙的训练结果（在揉合的数据集上直接训练），也许一段时间后我会再跟进改良它。另外我认为视频擦除是有前景的方向，其衍伸任务有很多，譬如敏感内容（涉黄涉暴等）擦除、广告擦除、指定人/物擦除、背景人擦除等等，只要能寻找到有像素预测的场景+有像素预测的需求都是“视频擦除”可以玩出花样的情景~<br/>
<p align="center">
